...
INSERT INTO `series` (system_id, pattern, series_name, description, units, ymin, ymax) VALUES (1,'R%GMES','GMES','?','Mv/m',-2,22),(1,'R%PASK','PASK','?','deg',NULL,NULL),
                                                                                              ...
                                                                                              (1,'R______CRFP','CRFP','?','kW',-1,14),(1,'R%CRFPP','CRFPP','?','deg',NULL,NULL),
                                                                                              ...
                                                                                              (1,'R%QMES','QMES','?','counts',NULL,NULL), (1,'R______CRRP','CRRP','?','kW',-1,14),
                                                                                              ...
                                                                                              (3, "%EnergyJitter(%)", "E. Jitter (%)", '?', 'Percent', NULL, NULL),
