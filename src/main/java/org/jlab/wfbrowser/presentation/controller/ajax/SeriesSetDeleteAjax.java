 ...
 * @author adamc
 */
@WebServlet(name = "SeriesSetDeleteAjax", urlPatterns = {"/ajax/series-set-delete"})
public class SeriesSetDeleteAjax extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(SeriesSetDeleteAjax.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int seriesSetId;
        try {
            seriesSetId = Integer.parseInt(id);
        ...
        try {
            ss.deleteSeriesSet(seriesSetId);
